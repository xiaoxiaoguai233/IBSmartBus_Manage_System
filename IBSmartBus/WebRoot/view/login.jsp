...
<div class="music-lgin" style="z-index:1001">
	<!--canvas-->
	<div class="music-lgin-all">
		...
		<div class="music-lgin-dh">
			...
			<!--消息框-->
			<div class="music-news">Hello！Wellcome To IBSmartBus~！</div>
		</div>
	...
	<div class="content-title" style="font-color:#f1424f !important;"><p>登&nbsp;录</p></div>
	
	<form action="../login.action" method="POST">
		<!--用户名-->
		<div class="music-lgin-text">
			<input class="inputname inputs" type="text" placeholder="用户名"name="UserName" />
		</div>
		<!--密码-->
		<div class="music-lgin-text">
			<input class="mima inputs" type="password" placeholder="密码" name="PassWord"/>
		</div>
		<!--确定-->
		<div class="music-lgin-text">
			<input class="my-button music-qd inputs" type="submit" value="确定" />
		</div>
	</form>
	<div style="width:50%;height:30px;margin:0 auto;" class="error_mse">${error}</div>
	<div style="margin:40px;" id="my-time"></div>
</div>

<p class="footer">Copyright 2020-06. All Rights Reserved & Power By 小小怪</p>
...
<script type="text/javascript">
	...
	$('.music-qd').click(function(){
		if(($('.inputname').val()=='')){
			$(".music-news").html("Please enter your UserName!")      
		}else if(($('.mima').val()=='')){
			 $(".music-news").html("Please enter your PassWord!")
...
<!--时间-->
<script type="text/javascript">
	setInterval(showon,1000);  //这里是使时间动起来的地方
	function showon() {
	    var date = new Date()
	    ...
	    document.getElementById("my-time").innerHTML = y+"-"+m+"-"+d +" " + hour + ":" + minute + ":" + second;
	}
 </script>
</body>
</html>